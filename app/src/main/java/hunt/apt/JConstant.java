...
public class JConstant {
    ...
    public static final String CAM_BEAN_NAME = "CamTest";
    public static final String BELL_BEAN_NAME = "BellTest";
    public static final String MAG_BEAN_NAME = "MagTest";
    public static final String CLOUD_BEAN_NAME = "CloudTest";
